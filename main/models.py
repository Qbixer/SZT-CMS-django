...
class Section(models.Model):
    ...
    url = models.CharField(max_length=255, unique=False, null=False, help_text="Required. Maximum 250 characters.")
    ...
    contentType = models.ForeignKey(ContentType, on_delete=models.SET_NULL, null=True, help_text="Optional. How the page should be displayed.")
